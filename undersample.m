...
%Applying kmeans function to unbalanced class training and validation set
training0=underSamplingAlgorithm(training0,size(training1,1));
validation0=underSamplingAlgorithm(validation0,size(validation1,1));
...
function kmeansData = underSamplingAlgorithm(data, k)

% Preallocate for performance
kmeansData = zeros(k, size(data, 2));
